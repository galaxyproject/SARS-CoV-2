...
@click.command("Run Download and SE+PE Illumina Covid workflows workflow")
...
def run_download_and_se_pe_illumina_covid_workflows(nc_45512_genbank_file, accessions_file, api_key, galaxy_url, history_id, new_history_name, publish):
    """
    Run Download and SE+PE Illumina Covid workflows workflow
    """
    gi = bioblend.galaxy.GalaxyInstance(galaxy_url, api_key)
    if history_id is None:
       if new_history_name is None:
           new_history_name = 'History for Download and SE+PE Illumina Covid workflows execution'
    ...
    workflow_id = 'e4604641-8de5-43ff-ba15-0ddc6e98ba53'
    inputs = {
...
if __name__ == '__main__':
    run_download_and_se_pe_illumina_covid_workflows()
