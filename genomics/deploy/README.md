...
For the use of Minimap2 the human reference genome hg38 is needed. Use the hg38 tag to have the reference genome included in the container.

```
docker run -p 8080:80 quay.io/galaxy/covid-19-training:hg38
```
